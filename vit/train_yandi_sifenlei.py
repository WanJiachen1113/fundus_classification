...
def main():
    ...
    #image_path = os.path.join(data_root, "dataset_pro")  # flower data set path
    image_path='./dataset_random'
    ...
    pretrained_dict34 = torch.load("./vit_base_patch16_224_in21k.pth")  # feiyan_mobilenetv3.pth是在基础网络mobilenetv3上训练肺炎数据的预训练参数
    #net1 = efficientnetv2_m(num_classes= 5)  # 原基础网络
    net1=vit_base_patch16_224_in21k(num_classes=21843)
    #print(net1)
    ...
    save_path1 = './jieguo/vit_base1.pth'
