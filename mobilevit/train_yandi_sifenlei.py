...
def main():
    ...
    image_path='E:/all_data/dataset_random'
    ...
    pretrained_dict34 = torch.load("./mobilevit_s.pt",map_location=device)  # feiyan_mobilenetv3.pth是在基础网络mobilenetv3上训练肺炎数据的预训练参数
    ...
    save_path1 = './jieguo/mobilevit_base1.pth'
